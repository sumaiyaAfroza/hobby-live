...
const {googleLogin} = useContext(AuthContext)
  ...
  const allform = Object.fromEntries(formdata.entries())
  console.log(allform)
    ...
    <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
      ...
      <div class="w-full flex justify-center">
        <button class="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          ...
          <span onClick={googleForm}>Continue with Google</span>
        </button>
      </div>

      <div class="mt-4 text-sm flex justify-between items-center container-mr">
                <p class="mr-3 md:mr-0 ">If you don't have an account..</p>
                <button class="hover:border register text-white bg-cyan-500 hover:border-indigo-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300"> <Link to='/register'>Register</Link></button>
            </div>
